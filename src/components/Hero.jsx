...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 px-8 md:px-16 lg:px-24 max-w-5xl ml-auto">
        <div className="mb-8 overflow-hidden">
          <p
            className="text-[#D4A853] text-base md:text-lg tracking-[0.35em] uppercase font-medium animate-fade-in-up"
        ...
        <h1
          className="font-display text-6xl md:text-7xl lg:text-8xl font-bold text-[#FDF8F3] mb-8 md:mb-12 leading-[0.95] text-left animate-fade-in-left"
        ...
        <p
          className="text-xl md:text-2xl text-[#FDF8F3]/70 mb-12 md:mb-16 font-light max-w-lg text-left leading-relaxed animate-fade-in-up"
        ...
        <div
          className="flex flex-col sm:flex-row gap-6 justify-start items-start animate-fade-in-up"
