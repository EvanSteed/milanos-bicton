      ...
      <div className="container mx-auto px-8 md:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          <div className="lg:col-span-7 animate-fade-in-left">
            ...
            <div className="flex flex-wrap gap-12 mb-12" role="list" aria-label="Restaurant statistics">
              {stats.map((stat, index) => (
                <div key={index} role="listitem" className="animate-fade-in-up" style={{ animationDelay: `${0.4 + index * 0.1}s` }}>
