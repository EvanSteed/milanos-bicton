...
const menuData = {
  starters: [
    ...
    { id: 5, name: "Chilli Prawns", price: "$24", desc: "Sauteed with fresh tomatoes, chilli, lemon, thyme, served with toasted garlic bread. (1/2 dozen)" },
    { id: 6, name: "Garlic Prawns", price: "$24", desc: "Pan fried with garlic, white wine, cream, served with steamed wild and jasmine rice. GF" },
    { id: 7, name: "Chilli Mussels", price: "$26", desc: "Local mussels tossed in rich tomato sauce, chilli, garlic and basil. Served with fresh bread. 1/2 kg." },
    { id: 8, name: "Arancini", price: "$18", desc: "Mini rice balls, lightly crumbed, served with tomato sauce, fresh rocket and shaved parmesan cheese. V" },
    { id: 9, name: "Oysters Natural", price: "$25", desc: "Fresh oysters served over ice with mignonette sauce. (1/2 Dozen) GF" },
    { id: 10, name: "Oysters Kilpatrick", price: "$26", desc: "Grilled oysters topped with bacon, kilpatrick sauce, served over a bed of rock salt. (1/2 Dozen)" },
    { id: 11, name: "Dusted Calamari", price: "$20", desc: "Lightly paprika crumbed calamari served with garden salad." }
  ],
  pizza: [
